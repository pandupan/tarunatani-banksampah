...
import { imageArtikelBank, imageDaurUlang, imageSampah } from "@/lib/image";
...
import 'swiper/css/pagination'
  ...
  return (
    <div className="container w-full border border-theme-green">
      ...
      <div className="flex flex-col justify-center pt-[-1] items-center  w-full h-full space-y-8 px-2 mx-auto">
