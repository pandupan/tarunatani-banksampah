...
import { produkAtas, produkBawah } from "@/lib/image";
  ...
  return (
    <div className="container w-full border border-theme-green">
      ...
      <div className="flex justify-between items-center w-full mx-auto mt-[75px] px-10">
          ...
          height={80}
          />
          <h2 className="text-2xl text-center underline-offset-4 my-10">Hasil Produk Tanaman</h2>
          <Image
          src="/images/leaf-4.png"
          alt="leaf"
          width={50}
